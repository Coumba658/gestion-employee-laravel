        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseSystem"
                    ...
                    <span>Gestion System</span>
                </a>
                <div id="collapseSystem" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('countries.index') }}">Pays</a>
                        <a class="collapse-item" href="{{ route('states.index') }}">Region</a>
                        <a class="collapse-item" href="{{ route('cities.index') }}">Department</a>
                        <a class="collapse-item" href="{{ route('departments.index') }}">Commune</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
